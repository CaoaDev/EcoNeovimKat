...
## This version is modified to the original version of EcoVim, it has more useful plugins.
...
NeoTree
![NeoTree](./.screenshots/7-NeoTree.png)

NeoTreeFloat
![NeoTree](./.screenshots/8-NeoTreeFloat.png)
...
![Side Blame](./.screenshots/7-NeoTree.png)
![Side Blame](./.screenshots/8-NeoTreeFloat.png)
</details>
